...
<section class="hero teaser">
  <div class="container is-max-desktop">
    <div class="hero-body">
      <img class="is-centered" src="figures/overview.svg" alt="overview" width="100%">
      <br>
      <h2 class="subtitle has-text-centered">
        ...
        <!-- We present a framework aimed at attributing synthetic images to their originating generative models, with a particular focus on Diffusion Models. Our proposed method leverages high-level features extracted from large pre-trained vision encoders, specifically CLIP and DINOv2. This approach is contrasted with traditional forensic techniques that rely on frequency-based fingerprints, offering a more robust solution that can handle Open-Set scenarios. The framework is evaluated under conditions where new generative models, unseen during training, may be introduced, demonstrating superior performance over existing methods, even with limited training data.  -->
      </h2>
    </div>
  </div>
</section>
  ...
  <div class="column is-four-fifths">
    ...
    <div class="content has-text-justified">
      ...
      <p>
        ...
        Next, we perform the classification task (of assigning each image to a class in $\mathcal{O}_\mathcal{K}\cup\{y_u\}$) following either a Linear Probe or a $k$-NN approach.
      </p>
    </div>
    <div>
      <img src="figures/learning_methods.svg" class="is-centered" style="width: 90%">
    </div>
    <br>
    <div class="content has-text-justified">
      <p>
...
<section class="section" id="Results">
  ...
  <div class="container is-max-desktop content">
    ...
    <h3 class="title">Open Set Attribution</h3>
    <img class="is-centered" src="figures/genimage-comparison.png" alt="overview" width="100%">
    <h3 class="title">Architecture ablation</h3>
    <img class="is-centered" src="figures/architecture-sweep.png" alt="overview" width="100%">
    <h3 class="title">Robustness</h3>
    <img class="is-centered" src="figures/robustness.png" alt="overview" width="100%">
